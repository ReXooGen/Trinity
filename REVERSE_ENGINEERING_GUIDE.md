...
For build **Sep 16 2026 20:47:43**, all **8 CTest suites / 21 source guards** passed. SHA-256: `B9CEFD550960B41C7D2C5E6BB2A76D2F2A347C384FAE5BB9E70A96E718D824D8`. Tests cover payload preservation, sparse retouch, profile storage, current native layouts, scan churn/yield, damage policy and overlay synchronization. They do not execute an end-to-end gameplay test. See [the material fix report](2026-09-16_fix-dye-material-report.md) for scope, evidence and the call path.
