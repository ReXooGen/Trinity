...
namespace trinity::game
{
    ...
    namespace
    {
                                          ...
                                          uint64_t a5, uint64_t a6, uint64_t a7)
        {
            ...
            __try { Player::Tick(); } __except (EXCEPTION_EXECUTE_HANDLER) {}
            __try { Player::RefreshSelf(); } __except (EXCEPTION_EXECUTE_HANDLER) {}
            __try { World::Tick(); } __except (EXCEPTION_EXECUTE_HANDLER) {}
            __try { Inventory::Tick(); } __except (EXCEPTION_EXECUTE_HANDLER) {}
            __try { Dye::Tick(); } __except (EXCEPTION_EXECUTE_HANDLER) {}
            __try { Equipment::Tick(); } __except (EXCEPTION_EXECUTE_HANDLER) {}
            __try { Friendly::Tick(); } __except (EXCEPTION_EXECUTE_HANDLER) {}
            __try { ServiceProtectionExpiry(); } __except (EXCEPTION_EXECUTE_HANDLER) {}
